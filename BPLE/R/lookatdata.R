...
Males2 <- acast(Agg2[Agg$Sex == "m",], Age~Year, value.var = "V1")
Females2 <- acast(Agg2[Agg$Sex == "f",], Age~Year, value.var = "V1")
...
lines(1959:2004, me02,col="blue",lty=3,lwd=1)
lines(1959:2004, fe02,col="red",lty=3,lwd=1)
...
legend("bottomright", lty=c(1,1,3,3,2,2), col=c("red","blue","red","blue","red","blue"),
legend=c("Female BP smoothed mxc","Male BP smoothed mxc","Female BP raw mxc5","Male BP raw mxc5",
		"Female RLE","Male RLE"))
dev.off()
